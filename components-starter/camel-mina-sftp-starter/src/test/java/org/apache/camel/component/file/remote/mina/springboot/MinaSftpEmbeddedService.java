 ...
 */
public class MinaSftpEmbeddedService extends AbstractTestService implements FtpService {
    private static final Logger LOG = LoggerFactory.getLogger(MinaSftpEmbeddedService.class);
    ...
    private Path testDirectory() {
        return Paths.get("target", "mina-sftp", context.getRequiredTestClass().getSimpleName());
    }
