...
@SpringBootTest(classes = JolokiaAgentAutoConfiguration.class,
		properties = "camel.jolokia.agent.systemPropertiesMode=override")
public class JolokiaAgentAutoConfigurationUsingSystemPropertiesTest extends JolokiaAgentTestBase {
