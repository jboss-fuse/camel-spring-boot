...
@SpringBootTest(classes = JolokiaAgentAutoConfiguration.class,
		properties = {"camel.jolokia.agent.kubernetesDiscover=false", "camel.jolokia.agent.serverConfig.port=0"})
public class JolokiaAgentAutoConfigurationOnK8sDisabledTest extends JolokiaAgentTestBase {
